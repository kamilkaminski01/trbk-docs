...
window.KB_CONTENT = (function () {
  ...
  A.rekrutacja = {
    ...
    blocks: [
      ...
      { t: "note", variant: "info", title: "Przykładowy fragment rozmowy", html: "<strong>Ty:</strong> Cześć, szukam ekipy, która wykona remont mieszkania w stanie deweloperskim, ok. [metraż] m², prosty standard. Zapewniam materiały, projekty są gotowe. Czy macie wolny termin na [miesiąc]?<br><strong>Wykonawca:</strong> Tak, możemy zacząć od drugiego tygodnia.<br><strong>Ty:</strong> Świetnie. Prowadzą Państwo działalność i wystawiają fakturę VAT?<br><strong>Wykonawca:</strong> Tak.<br><strong>Ty:</strong> W jakim czasie jesteście w stanie wykonać remont i w jakiej cenie?<br><strong>Wykonawca:</strong> Orientacyjnie około 6 tygodni; dokładną wycenę prześlę po obejrzeniu lokalu.<br><strong>Ty:</strong> Jasne. Rozliczamy się albo etapami (przy ustalonym postępie prac), albo na koniec remontu - jak Państwu wygodniej. Umowę przygotowujemy my; jeśli będziecie chcieli nanieść zmiany w zapisach, jesteśmy otwarci na ustalenia.<br><strong>Wykonawca:</strong> Pasuje. Prześlijcie umowę do wglądu i umówmy oględziny na miejscu.<br><strong>Ty:</strong> Super - wysyłam wzór i proponuję termin na inwestycji. Do zobaczenia." },

      { t: "h", text: "Umowa z ekipą" },
      { t: "p", html: "Umowę zawsze zawieramy na <strong>gotowym wzorze, który dostarcza flipper</strong>. Nie tworzysz własnych umów ani nie zlecasz prac „na słowo”. To my dostarczamy umowę; jeśli wykonawca chce zmian w zapisach, można je ustalić (w razie potrzeby skonsultuj z flipperem)." },
      { t: "note", variant: "info", title: "Rozliczenie", html: "Model rozliczenia komunikujemy my - albo <strong>etapami</strong> (przy ustalonym postępie prac), albo <strong>na koniec remontu</strong>. Który wariant stosujemy na danej inwestycji, ustal z flipperem." },
